...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_CAPS,    KC_INSERT,      KC_DELETE,      KC_DOWN,        KC_UP,                                                                                                          KC_LEFT,        KC_RIGHT,       KC_HOME,        KC_END,         KC_MEH,
                                                                                                    MT(MOD_LCTL, KC_ESCAPE),KC_LGUI,        MT(MOD_RGUI, KC_GRAVE),MT(MOD_RCTL, KC_TAB),
                                                                                                                    KC_DEL,KC_INS,
                                                                                    MT(MOD_LSFT, KC_ENTER),QK_REP,       KC_LALT,        KC_RALT,        KC_BSPC,      LT(1,KC_SPACE)
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,        KC_WWW_FORWARD,                                 KC_WWW_BACK,    KC_CIRC,        KC_1,           KC_2,           KC_3,           KC_QUOTE,       KC_TRANSPARENT,
    KC_TRANSPARENT, KC_ASTR,        KC_LCBR,        KC_LPRN,        KC_RPRN,        KC_RCBR,                                                                        KC_AMPR,        KC_4,           KC_5,           KC_6,           KC_DQUO,        KC_TRANSPARENT,
    KC_TRANSPARENT, KC_BSLS,      KC_PIPE,        KC_LBRC,    KC_RBRC,    KC_EQUAL,       KC_BRIGHTNESS_UP,                                KC_BRIGHTNESS_DOWN,KC_MINUS,       KC_7,           KC_8,           KC_9,           KC_0,           KC_TRANSPARENT,
